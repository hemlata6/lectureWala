        ...
        if (item?.entityType) {
            ...
            if (item?.entityType === "quiz") {
                ...
                if (item?.quiz?.attempt === true) {
                    ...
                    onQuizNavigation && onQuizNavigation('result', item);
                } else {
                            ...
                            >
                                ...
                                <div className="p-6 flex-grow flex flex-col justify-between">
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        {/* Action Button */}
                                        <button onClick={() => handleCardClick(item)} className={`w-full py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex items-center justify-center gap-2 ${!courseId && !item?.entityType
                                            ? item?.setting?.restrictFreeContent === true && !enrolledCourses.has(item?.id)
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-fade-in">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 text-white">
                            <div className="text-center">
                                ...
                                <p className="text-white/90 text-sm">
                                    You need to be logged in to start the quiz
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-gray-600 text-sm">
                                    Please login or create an account to access this quiz and track your progress.
                                </p>
                            </div>
